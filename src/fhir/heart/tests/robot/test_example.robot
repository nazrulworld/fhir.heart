...
#
#  $ bin/test -s fhir.heart -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src fhir.heart.testing.FHIR_HEART_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/fhir/heart/tests/robot/test_example.robot
#
